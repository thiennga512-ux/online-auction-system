...
public class ServerMain {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      DepositRequestService depositRequestService = new DepositRequestService(userService, userDAO);
      ...
      RequestDispatcher dispatcher = new RequestDispatcher(
          userService, authService, registrationService, auctionService, itemService, autoBidService, depositRequestService);
  ...
  private static void initializeDemoData(
    ...
    // Tạo Admin
    Admin admin = registrationService.createAdmin("Admin Hệ Thống", "admin", "admin@auction.vn", "admin@123");
    
    // Tạo Seller
    Seller seller = registrationService.registerSeller("Nguyễn Văn Bán", "seller@auction.vn", "seller@123", "Tech Store HCM");
    
    // Tạo Bidder
    Bidder bidder1 = registrationService.registerBidder("BI BI BI", "bidder1@auction.vn", "bidder@123");
    ...
    // Tạo sản phẩm
    Electronics laptop =(Electronics) ItemFactory.createNewItems(
