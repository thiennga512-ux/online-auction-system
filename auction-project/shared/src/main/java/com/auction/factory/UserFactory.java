...
public class UserFactory {
    ...
    public static User create(UserRole role, String username, String passwordHash, String email, String fullName) {
        return switch (role) {
            ...
            case SELLER -> new Seller(username, passwordHash, email, fullName, 0.0); // Mặc định rating 0.0
    ...
    public static Bidder rebuildBidder(String id, LocalDateTime createdAt, LocalDateTime updatedAt, 
        ...
        return new Bidder(id, createdAt, updatedAt, username, passwordHash, email, fullName, active, balance, frozenBalance, address);
    }
     ...
     * Tùy vào giá trị cột 'role' trong DB mà hàm này sẽ gọi đến hàm rebuild tương ứng.
     */
