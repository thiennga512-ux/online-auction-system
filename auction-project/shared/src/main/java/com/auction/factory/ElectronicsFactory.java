...
public class ElectronicsFactory extends SubItemFactory {
    ...
    public Item create(String name, String description, double price, double inc,
        ...
        return new Electronics(name, description, price, inc, img, sId, getStr(data, "brand"), getStr(data, "model"),
                getInt(data, "warrantyMonths"), parseEnum(Electronics.Condition.class, data.get("condition")));
    }
