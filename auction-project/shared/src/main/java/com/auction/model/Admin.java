...
public class Admin extends User {
    ...
    public Admin(String username, String passwordHash, String email, String fullName, String gender, String dateOfBirth) {
        super(username, passwordHash, email, fullName, UserRole.ADMIN, gender, dateOfBirth);
    }
    ...
    public Admin(String id, LocalDateTime createdAt, LocalDateTime updateAt, String username, 
        ...
        super(id, createdAt, updateAt, username, passwordHash, email, fullName, UserRole.ADMIN, active, gender, dateOfBirth);
    }
