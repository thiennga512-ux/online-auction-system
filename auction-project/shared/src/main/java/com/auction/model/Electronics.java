...
public class Electronics extends Item {
    ...
    public enum Condition {
        ...
        Condition(String display) { this.display = display; }
    ...
    public Electronics(String id, LocalDateTime createdAt, LocalDateTime updateAt, 
        ...
        super(id, createdAt, updateAt, name, description, startingPrice, bidIncrement, imageUrl, sellerId, ItemCategory.ELECTRONICS);
        this.brand = brand;
        this.model = model;
        this.warrantyMonths = warrantyMonths;
        this.condition = condition;
