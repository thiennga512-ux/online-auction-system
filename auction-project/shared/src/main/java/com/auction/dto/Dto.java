...
public class Dto {
    ...
    public record ListItemRequest(
            ...
            String artistName, Integer creationYear, String medium, Boolean authenticated, String certificateId,
            String dimensions,
            String vehicleType, String make, Integer year, Integer mileage, String fuelType, String transmission,
