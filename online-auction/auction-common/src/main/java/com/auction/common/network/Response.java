...
/**
 * ============================================================
 * Class Response — Biểu diễn một Gói tin trả về từ Server -> Client
 * ============================================================
 *
 ...
 *   "data": { ... list bids / user object ... },
 *   "actionType": "LOGIN"  // Giúp Client nhận biết đây là response của request nào
 * }
 * ============================================================
 */
public class Response {
  ...
  public static Response success(ActionType action, Object dataObj) {
    return success(action, "OK", dataObj);
  }
