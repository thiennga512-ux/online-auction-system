...
/**
 * ============================================================
 * Class SocketClient — Quản lý kết nối mạng cho Client
 * ============================================================
 *
 * Nhiệm vụ:
...
public class SocketClient {
  ...
  public void sendRequest(Request request) {
    if (!isConnected()) {
      ...
      Platform.runLater(() -> {
          // Thông báo cho các listener về lỗi kết nối nếu cần
          Response error = Response.error(request.getAction(), "Mất kết nối tới Server. Vui lòng kiểm tra lại Server.");
    ...
    String json = request.toJson(); // Dùng method toJson() của Request đã có sẵn \n
    out.print(json);
    out.flush();
